...
from example_polymarket_overlay.model_development_macro_polymarket_overlay import (
...
def main():
    ...
    output_dir = Path(__file__).parent / "output_macro"
    run_full_analysis(
        btc_df=btc_df,
        features_df=_FEATURES_DF,
        compute_weights_fn=compute_weights_wrapper,
        output_dir=output_dir,
        strategy_label="MA + Macro Polymarket Overlay",
