...
SHAYAN_DIR = Path(__file__).resolve().parents[1]
...
DEFAULT_CONFIG = {
    ...
    "base_lstm_weight": 0.30,
    "base_snp_weight": 0.10,
    "base_halving_weight": 0.05,
    "confirmation_weight": 0.05,
    "recovery_target_ma_weight": 0.45,
    "recovery_target_sentiment_weight": 0.05,
    "recovery_target_lstm_weight": 0.40,
...
def compute_window_weights(
    ...
    blended = (
        (1.0 - cfg["confirmation_weight"]) * base_weights
        + cfg["confirmation_weight"] * confirmation_weights
    )
